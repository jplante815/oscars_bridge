...
@WebService
public class OSCARSBridge //implements OSCARSBridgeInterface
{  
    ...
    **************************************************************************/
    ...
    {    	
    	try
        {
    		...
    		oscarsClient = new OSCARSClient(oscars_url, oscars_url + "?wsdl");	// Connect to OSCARS
    ...
    **************************************************************************/
    ...
    {       
    	System.out.println("ACTUALLY GETTING TO THE BRIDGE!!!!!!");
